...
export class MainUI extends Phaser.Scene {
    ...
    create() {
        ...
        const tools = [
            ...
            { id: 153, frame: 4, key: '8', is3x3: false, label: 'Police' },
            { id: 156, frame: 5, key: '9', is3x3: false, label: 'Fire' },
            { id: 195, frame: 5, key: 'Q', is3x3: false, label: 'Seaport' },
            { id: 198, frame: 4, key: 'W', is3x3: false, label: 'Airport' },
            { id: 150, frame: 6, key: 'E', is3x3: false, label: 'Power Plant' },
            { id: 192, frame: 6, key: 'R', is3x3: false, label: 'Train Depot' },
            { id: 201, frame: 4, key: 'A', is3x3: false, label: 'Mayor House' },
            { id: 204, frame: 5, key: 'S', is3x3: false, label: 'Casino' },
            { id: 207, frame: 6, key: 'D', is3x3: false, label: 'Amusement' },
        ];
